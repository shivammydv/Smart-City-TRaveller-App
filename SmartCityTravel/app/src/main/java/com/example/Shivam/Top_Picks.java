...
public class Top_Picks extends ListActivity {
    ...
    private class fourquare extends AsyncTask<View, Void, String> {
        ...
        protected String doInBackground(View... urls) {
            ...
            temp=makeCall("https://api.foursquare.com/v2/venues/search?&radius=10000&limit=50&client_id="+CLIENT_ID+"&client_secret="+CLIENT_SECRET+"&v=20130815&ll="+lat+","+lng);
            //temp = makeCall("https://api.foursquare.com/v2/venues/explore?&radius=10000&limit=50&client_id="+CLIENT_ID+"&client_secret="+CLIENT_SECRET+ "&v=20130815&ll=28.70,77.10");
            return "";
        }
        ...
        protected void onPostExecute(String result) {
            if (temp == null) {
                ...
                myAdapter = new ArrayAdapter<String>(Top_Picks.this, R.layout.row_layout, R.id.listText, listTitle);
